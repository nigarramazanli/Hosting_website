...
let result_circle;
const x=+prompt("Please enter the value x");
const y=+prompt("Please enter the value y");
const r=+prompt("Please enter the value r");
if(x*x+y*y<r*r){
    result_circle="The point lies inside the circle";
}
else if(x*x+y*y==r*r){
    result_circle="The point lies on the circle";
}
else{
    result_circle="The point lies outside the circle";
}
